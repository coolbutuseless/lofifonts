...
colnames(arcade) <- c("char", "stroke_idx", "x", "y", "point_idx", "width", "height")

arcade$codepoint <- vapply(arcade$char, utf8ToInt, integer(1))

arcade <- arcade[, c('codepoint', 'stroke_idx', 'point_idx', 'x', 'y', 'width', 'height')]
