...
#' @noRd
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
read_bdf <- function(filename, codepoint_from_startchar = FALSE) {
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  chars <- lapply(char_chunks, parse_char, height = font_info$size, codepoint_from_startchar = codepoint_from_startchar)
...
#' @noRd
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
parse_char <- function(txt, height, codepoint_from_startchar) {
  ...
  if (isTRUE(codepoint_from_startchar)) {
    # cat(".")
    startchar <- txt[[1]]
    startchar <- strsplit(startchar, "\\+")[[1]][2]
    encoding <- strtoi(startchar, base = 16)
  }
